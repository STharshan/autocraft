  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white max-w-3xl mt-50">
        ...
        {/* Heading */}
        <h2 className="text-4xl md:text-7xl font-semibold text-blue-600 mb-10">SERVICE</h2>

        {/* Subtext */}
        <p className="text-gray-300 text-base md:text-lg font-semibold">
          We do more than just routine
        </p>
        <p className='text-gray-300 text-base md:text-lg mb-8 font-semibold'>maintenance</p>
...
export default BodyServiceHeader;
