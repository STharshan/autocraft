...
const PrecisionRepairs = () => {
  ...
  // ✅ Function to redirect to /services
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        >
          ...
          <div className="bg-linear-to-br from-yellow-300 to-white dark:from-[#D9C814] dark:to-black relative p-6 flex flex-col justify-end">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300 z-10">
              Expert Technicians
            </p>
          </div>
        ...
        {/* RIGHT COLUMN: TEXT */}
        <div data-aos="fade-left" className="md:text-left md:w-1/2 mx-auto">
          ...
          {/* ✅ Discover More Button with redirect */}
          <button
