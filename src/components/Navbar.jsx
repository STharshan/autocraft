              ...
              <div className="absolute top-full mt-4 right-0 w-[400px] bg-white dark:bg-black text-black dark:text-white px-6 py-4 rounded-lg shadow-xl z-50 border border-gray-200 dark:border-gray-700">
                <div className="flex space-x-6">
                  <div className="space-y-2 pr-20">
                    <a href="/" className="hover:text-[#D9C814] dark:hover:text-[#D9C814] text-sm leading-tight py-1 block">Home</a>
                    <a href="/about" className="hover:text-[#D9C814] dark:hover:text-[#D9C814] text-sm leading-tight py-1 block">About</a>
                    <a href="/services" className="hover:text-[#D9C814] dark:hover:text-[#D9C814] text-sm leading-tight py-1 block">Services</a>
                    <a href="/gallery" className="hover:text-[#D9C814] dark:hover:text-[#D9C814] text-sm leading-tight py-1 block">Gallery</a>
                  </div>

                  <div className="border-l border-gray-300 dark:border-gray-700"></div>

                  <div className="space-y-2 pl-4">
                    <a href="/pricing" className="hover:text-[#D9C814] dark:hover:text-[#D9C814] text-sm leading-tight py-1 block">Pricing</a>
                    <a href="/contact" className="hover:text-[#D9C814] dark:hover:text-[#D9C814] text-sm leading-tight py-1 block">Contact</a>
                  </div>
                </div>
              </div>
            )}
