    ...
    <section className="bg-linear-to-b from-gray-50 to-white dark:from-gray-900 dark:to-black py-16 sm:py-20 lg:py-24 px-4 relative transition-colors overflow-hidden" id="paint-work">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-linear-to-r from-blue-600 to-blue-400 dark:from-blue-400 dark:to-blue-300 bg-clip-text text-transparent mb-4">
            Our Gallery
          </h2>
          <div className="w-24 h-1 bg-linear-to-r from-blue-600 to-blue-400 mx-auto mb-6 rounded-full"></div>
